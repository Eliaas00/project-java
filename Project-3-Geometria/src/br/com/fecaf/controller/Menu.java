            ...
            switch (optionUser) {
                ...
                case 3:
                    ...
                    while (!exitTriangulo) {
                        ...
                        System.out.println("/* 2 - Calcular Área                          */");
                        System.out.println("/* 3 - Calcular Perimetro                     */");
                        System.out.println("/* 4 - Definindo Tipo                         */");
                        System.out.println("/* 5 - Definindo Retangulo e 3 4 5            */");
                        ...
                        switch (optionTriangulo) {
                            case 1:
                                ...
                                validoTriangulo = triangulo.cadastrarTriangulo();
                                break;
                            case 2:
                                if (validoTriangulo) {
                                    System.out.println("Calculando Área");
                            ...
                            case 5:
                                if (validoTriangulo) {
                                    System.out.println("Definindo Retangulo e 3 4 5: ");
                                    triangulo.definindoTriagulo345();
                                } else {
                                    System.out.println("Cadastre um Triângulo...");
                                }
                                break;
